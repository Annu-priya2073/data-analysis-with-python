...
- Data visualization using plots & graphs
- Insight extraction from customer purchasing patterns
...
│
├── Ecommerce_Customer_Dataset_EDA.ipynb    # Main notebook file
├── dataset/                               # Dataset file
│   └── ecommerce_customer_dataset.csv
│
